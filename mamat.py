...
cl = LINETCR.LINE()
cl.login(token="ElhKGQgHQzFQhJIM3Gka.kkhh2MyL2h9HXFfBcBqwEG.ZhEjDU7NSYv70KLro8LtYcMy2wjjyIxaX7fVXdTMWMQ=")

ki = LINETCR.LINE()
ki.login(token="ElNfuQahJmnrdKHTDmE4.9dw7YOu+Ds5k2+16Id38La.RTqmCKRL1fGfgCsu9nyCPB8kgHmcj/Cj9FBnb0pW+AI=")

ki2 = LINETCR.LINE()
ki2.login(token="ElnnNsV71fZdqGGVjSub.3fplOB8/jbF3qHJ6sMn+6W.DILFrloLQ87r4LEwgleDIyQ+KQsu/ABn6jawslFaQ/8=")

ki3 = LINETCR.LINE()
ki3.login(token="Elf72lSGyeguQKN2mfha.9+OcaBacHbP3rvdzNm8JMG.YXG+n0yGlgs3f1yc2iNYcNlqeDqI0BGa/6P9tL7UIW0=")

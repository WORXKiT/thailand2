...
kc = LINETCR.LINE()
kc.login(token="EmUeDIc8prkonXjlmfQa.DP7HM0ARnuIu/2g0+3pMUG.msgKJkdjAd98StPichEbxvX5/wwFl1frxvMGpkUYbfU=")
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token="EmHDNDG1FUdqebKsPccb.8udcfgLi7ehlJbE2o+xCkW.jseObjZZHj1bNRk0uMopJT3vvlsZ28Zc/OVE3i/Xvso=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="EmHT2Tm67a83vIgx18r4.XzkQX6Z6SKas/aWEdxhG9a.3mwDO2kLX6ZazhyvQnt9BWdTZrjfTpUY+/Qd6cnl2WE=")
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token="Em50bBhd9l6NBcG3ACoa.M18YOGKVCrQRdiHWLocYoG.Pv3wn+GzMHZ/MtBMSSNwPjCpknm/B2agRIZ2qwW4PCA=")
kf.loginResult()

kg = LINETCR.LINE()
kg.login(token="Emlfok3aFH4v1nW3P11c.no4dMxrsd11rTBtXMaDXxa.knA00ymHax19RIWszKxQ4IM7jr4fq8k3l7OpjsxZIhE=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="Em3HJNZ4YVnHpnjAG3s2.HczpEpY3698wuSB+TzCDKG.QqUCfUxvWu32ATH3LTt+IxlpJlR6iBwLdaHxPWKhZao=")
kh.loginResult()

kj = LINETCR.LINE()
kj.login(token="Em9OpGPZjTb9U3C6TBFd.3ZijQj/+HYJ/+9NTGXTdBq.LuUjEbBfJFB3DAdez4fs24F/iJPmczJqcj1DE4gTTKg=")
kj.loginResult()

kl = LINETCR.LINE()
kl.login(token="EmGfb3t7NXBnfIUEUSb7.PxA11UvF6+oIj1J2xHVgHW.3/U1lQrQJrGVn0Z5g5OXUIhQLOuogbd7secLNWHbUDM=")
kl.loginResult()

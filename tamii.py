...
cl = LINETCR.LINE()
cl.login(token="Em1xW6wTdTkheX34DpV6.TZBfSxLpwQmajTfI0hZL5G.GEs+Kx9xOx2w6G9DEaQFxtmLqwC4IV7nADZmh06TSrk=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmWvoLao5C9aqCdBJkqa.DP7HM0ARnuIu/2g0+3pMUG.QjgwHKxTi7VukCCjQ6+sw4SMu4BZuH2iGWqccC1qKGg=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EmRR5zIU2tWvDPaj3J0a.M5S4YxDWvhoYOasbMPWroG.K/KSRCIUKCxVH1OepIhTNUqVbPgtE5l48PAAaO3VLRQ=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EmpYFo0O1zTYWa9Q2Pu4.9gH7ABV+xQLJo9i7SbFX5a.tOVi98A/jfKV9b6ylBNbVpg34eBZ7Jn1QUeOOUHyetA=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token=" EmvAn3y18h8CgU1zjJcb.8udcfgLi7ehlJbE2o+xCkW.rJelPQjOz20/cxTb9ZucwAvYbY3MOzbQYk+zQFFg1mw=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Em2ZoBjWDWntzmrSZju4.XzkQX6Z6SKas/aWEdxhG9a.+0AJsC05IELf/5Cn4XvkpzozAPZtA44SlSKwpsoZROE=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="EmsfL08UjeMw9Ika4hla.M18YOGKVCrQRdiHWLocYoG.hMyK1N4oXNQKRLvVM2dAgrbJGXfsgmOJlMJMO63cud0=")
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token="EmxyTL28SwfkrnJB5Ba0.xk6CFUa1TffEm+BFjYuhCa.n73jRSozAfRw3DuVhEC1W39bqLKOnwnZG1ll4ukC2Qw=")
ki7.loginResult()

ki8 = LINETCR.LINE()
ki8.login(token="Emly9ol5y1RbL4tYKiT2.HczpEpY3698wuSB+TzCDKG.i6iGa3ki/s4558tdDgU1qRc6Lgc7K9q/vysC59oAy3U=")
ki8.loginResult()

ki9 = LINETCR.LINE()
ki9.login(token=" EmRB3q0WcFtIEYBkympd.3ZijQj/+HYJ/+9NTGXTdBq.TbZqdL+uokrcAo+A0NWNaBtP+JGZF2R7uTlgCRblq/0=")
ki9.loginResult()

ki10 = LINETCR.LINE()
ki10.login(token="EmweLma0g9P4z2mZcdE7.PxA11UvF6+oIj1J2xHVgHW.zV07fVaE0paqw2GZmTWZ4mPpQi7/Ux1WPK4ICPB6lGY=")
ki10.loginResult()

ki11 = LINETCR.LINE()
ki11.login(token="EmZjvPxggKIRpuHfKtbc.R7wlDcf67amXdreJrsscNa.3AtZRleKlVJDXJDAmp0tATi2rK7DZt0GjHT5QB7znBE=")
ki11.loginResult()

ki12 = LINETCR.LINE()
ki12.login(token="Em65O5Eb6G3doUAOKnGb.3ZPYZKPkms/HbQTtAV24/W.ro30CJlbVIPZ+Q4cYQZMHIvHNi7QjhZQjc93W/E05nk=")
ki12.loginResult()

ki13 = LINETCR.LINE()
ki13.login(token="EmJAce0f3JE0yeGTVUa2.752/iGy+YeEbmgsDur71SG.lJBcg2Mmv8Ta5ddVNEi6/jSxERaZNxHbBD3J4qPZUHM=")
ki13.loginResult()

ki14 = LINETCR.LINE()
ki14.login(token="EmFFXFAlv2tesonuXip7.EEbmd/OLTc2Uu8OPqO1pXW.3EoCUYeK/t00MLqVZyzXXeG9SysGd9BR0t0kAiAoc/w=")
ki14.loginResult()

ki15 = LINETCR.LINE()
ki15.login(token="EmrTPLmjMkN2SpsN5Wad.zfQ3ZbkGgwAclgq1I5i8Vq.G3yM8wZCvprLBU6qA48fS/PJq/tkh/GpKGpMIwaZZGY=")
ki15.loginResult()

ki16 = LINETCR.LINE()
ki16.login(token="Emd1mAvZYkSRB6PSAaC6.Wu+hErYx54kx/IkHj4IB1G.IcChRkDKqZzdgZmtPvyoDr+vJuHaPQanf1POH6PBbnM=")
ki16.loginResult()

ki17 = LINETCR.LINE()
ki17.login(token="EmYOteugdZPbj2sWem3c.s80ZJQcHs0kVH2UrrWnxRa.viwDoI9SyE6u9xDUQGErmGUfn1gOdUvjfSENBRtAsaM=")
ki17.loginResult()

ki18 = LINETCR.LINE()
ki18.login(token="EmNB62r0v5709Nc8tZRf.ZNZPIvbifOu1q1RqGxbSNW.8+T+NoXrPnqb2IaOnkq7Q2Xmo8tDpywATkNTjagiuDI=")
ki18.loginResult()

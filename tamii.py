...
cl = LINETCR.LINE()
cl.login(token="Ems0jifdsc0lCvJJQxic.F8CkqFwMeUfBCsnP0ArOJa.jwkXKKhlSqOB/1+M181J7X/KjeMJ5yNvWu7EU1kHMms=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmOqlI5rCfBzEr0kOyma.aeWctXn5skH57pYaVtEgsG.QMKK50OWFmQmuclB7Wxf5NYGgArnAJU7cfzYaUcJwWw=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Em9Irf0h0JFisNhNRZ64.YBk0hgUO7cVeEp8d++80fa.zF/lTWGrwiD5DRMR/P3xykua3ggh9NIXI5l5+GajypY=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EmMviIzNU2DCEpgyDlZ1.MWXbzGUbpplEkuLbO9LOqq.ERCuxNMs+1yyJOkBTAb3b8IacVyvb4Vq6PSnnG1C2WY=")
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token="Emn92hUatJvXaf9Icpxe.DuYZVJsRNeq5mGL6vS9sRG.nE81+56oUmFJdnWSFuolk+YaunqptiWurrgpSSzQQAg=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="Emn92hUatJvXaf9Icpxe.DuYZVJsRNeq5mGL6vS9sRG.nE81+56oUmFJdnWSFuolk+YaunqptiWurrgpSSzQQAg=")
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token="EmflQr2RJ0va4SdBkZl5.5nsid46hKNhZbJ/puSQDPq.mM4Rx9P5+1fUe8nouMlxbkXrDWXOlwMP1tiL2xQJjNw=")
kf.loginResult()

kg = LINETCR.LINE()
kg.login(token="Em58hr3SLyZ4pXpIHdPd.rrgMaZym4KNKknwjwX2s+q.uoqP4UAH1wrTUYjyPoi/uatt1P8cJ6tv9tTvFGpPlRs=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="EmlgZeqBz2dlJ5bcHxF9.XzzlkT0kgA/Oj/UcsLNWAq.qdAskw7NMMuCtge/v9EUzjGHZZRRKxHQeUihmxqFJRI=")
kh.loginResult()

kj = LINETCR.LINE()
kj.login(token="Em9A5oDO26hdjclPO11c.alkIiYos+Y3CVh3hGjp8Za.n/CRkEkf8AxaDLd2JLh/yQ3J+zTC2F+rD8M3RM2cuIU=")
kj.loginResult()

kl = LINETCR.LINE()
kl.login(token="Emh2qTvA84sBI2CSBYE3.rLJ1dxpxp5MNKYyypXaWGW.6Wv4n6Wjrp8UKP1omB075Pg6MI4WjrSC9GnyXc6Wkog=")
kl.loginResult()

km = LINETCR.LINE()
km.login(token="EmjP4DBjfrzpgf1u8Qq4.L4exci3szO9h4ZL/Z4ad5a.RRVAfdOPlTOkhOFhEaF8OGVr/Zi2juhuNKno02RsvWM=")
km.loginResult()

kn = LINETCR.LINE()
kn.login(token="EmNrQRK2J69J9Y4yyCf8.DKyDAU0LINmg3u5FHwfG6a.CpDD0/Avz22TeWokkD26nJdxFcG3kSiaX6xpqv0raV8=")
kn.loginResult()

ko = LINETCR.LINE()
ko.login(token="EmgcrGlkhB48xCc8uuve.wfZckOaR6NJTjcCR3C2oJG.gIhaZC408PFc5zh/cxRCQB/nU88aMh7enhlT3Q9BXa4=")
ko.loginResult()

kp = LINETCR.LINE()
kp.login(token="Em9DFRMY6gNpka67DrP8.k5XfWS4HnzGfC9nScH9j2a.BM44M8nBxhhkz+8iGjCaRxjG64vAliTpVjU/W8QlJ/E=")
kp.loginResult()

kq = LINETCR.LINE()
kq.login(token="EmKhVZp3Wj8G7LqK74e9.fzsrB/aVXJ6adNWesJ9EIq.RCMrJScbBodm1UEw9DviCmSkN4Kyu7sV6XOBORxcyNs=")
kq.loginResult()

kr = LINETCR.LINE()
kr.login(token="Emowm2JSPZo0aavTX7B8.I0Um4rdjp1QG35gwtsnhEa.5vgIheCDZyIFcOL4Bt6RfAvLA0vzc1TNQQDwMkuORYc=")
kr.loginResult()

ks = LINETCR.LINE()
ks.login(token="EmXx4DSttywDVgt2pnUd.MYMHVSUJcHp/4DbTeTnxlq.ysIuPKpYYQb1jVgKfKq0x69/4xcjbr12WTwegFbPADE=")
ks.loginResult()

kt = LINETCR.LINE()
kt.login(token="EmUd5LLSNBzpr3UEaaP9.FmCPU37iPl8qtGGH6gDq/q./vhAq+ta2l/JWlFkGQgxIHLCoqGE/OQdsCI97JtVez4=")
kt.loginResult()
...
#========================================
				...
				for i in gid:
					...
					kt.leaveGroup(i)
				if wait["lang"] == "JP":
					random.choice(KAC).sendText(msg.to,"KAMI PAMIT TEMAN👋😂")
				else:

...
ki11 = LINETCR.LINE()
ki11.login(token="EmixNnGHVllYuLaHhGkc.R7wlDcf67amXdreJrsscNa.xlMQLXOLdXW1xARkwkY+gxJSxB0S8oV21xuhutmCD8s=")
ki11.loginResult()

ki12 = LINETCR.LINE()
ki12.login(token="Emm6aEsehMtSqXANCsvb.3ZPYZKPkms/HbQTtAV24/W.+KKDo2LcvY6yno6S02s3IXJ7hs764ofB1t2ivo5ZGts=")
ki12.loginResult()

ki13 = LINETCR.LINE()
ki13.login(token="EmsVFWUdj3w0FSDvGID2.752/iGy+YeEbmgsDur71SG.2M9CfYi+ex2LJ8buXuzOV8ZX5GzR4wzJXMS9kxCwemI=")
ki13.loginResult()

ki14 = LINETCR.LINE()
ki14.login(token="EmE3ZXqNvpUhbDywWCi7.EEbmd/OLTc2Uu8OPqO1pXW.ctqoU7ewelejaf0UoXuD3NuZh7yKUl73j9ZPSdJ2hPk=")
ki14.loginResult()

ki15 = LINETCR.LINE()
ki15.login(token="EmblcF6dgJ1fhw1ETqwd.zfQ3ZbkGgwAclgq1I5i8Vq.6CeBrYzmbqeRozOhhPkYEGEWFwA9s6LbDdTQb4q+voA=")
ki15.loginResult()

ki16 = LINETCR.LINE()
ki16.login(token="EmDXWKfB62cLkUWjsgc6.Wu+hErYx54kx/IkHj4IB1G.FukxAoerSfF/irjDjHv0ZCoDZoLCyoDA+v6TKGnVlRA=")
ki16.loginResult()

ki17 = LINETCR.LINE()
ki17.login(token="EmuCn8lvev5jPEfbwLIc.s80ZJQcHs0kVH2UrrWnxRa.MOxjIhXxHcBX0kfPb23xe8UqE/axyRfYDulIdJImB60=")
ki17.loginResult()

ki18 = LINETCR.LINE()
ki18.login(token="EmgLWQ9WuYg89DrUjnxf.ZNZPIvbifOu1q1RqGxbSNW.f6b84nIxatY88U3k6nimjz9YY8gVweVTBwHRARNRZ5E=")
ki18.loginResult()
